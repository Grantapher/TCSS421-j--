...
class JavaCCParser implements JavaCCParserConstants {
    ...
    private void recoverFromError(int[] skipTo, ParseException e) {
        ...
        if (e.expectedTokenSequences.length == 1) {
            ...
            reportParserError("\"%s\" found where one of %s sought", getToken(1),
                              expected
            );
        }
    ...
    final public JCompilationUnit compilationUnit() throws ParseException {
        ...
        {
            if (true) return new JCompilationUnit(fileName, line, packageName, imports,
                                                  typeDeclarations
            );
        }
    ...
    final private JClassDeclaration classDeclaration(ArrayList<String> mods) throws
            ParseException {
        int line = 0;
        String name = "";
    ...
    final private JVariableDeclaration localVariableDeclarationStatement() throws
            ParseException {
        int line = 0;
        Type type = null;
    ...
    final private ArrayList<JVariableDeclarator> variableDeclarators(Type type) throws
            ParseException {
    ...
    final private JVariableDeclarator variableDeclarator(Type type) throws
            ParseException {
        int line = 0;
    ...
    final private JArrayInitializer arrayInitializer(Type expected) throws
            ParseException {
        int line = 0;
        ...
        try {
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                case DOT:
                    ...
                    expr = new JFieldSelection(line, ambiguousPart(id), target,
                                               id.simpleName()
                    );
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        case LPAREN:
                            args = arguments();
                            expr = new JMessageExpression(line, target, ambiguousPart(id),
                                                          id.simpleName(), args
                            );
                            break;
                        default:
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    ...
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        ...
                        case DOT:
                            ...
                            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                                case LPAREN:
                                    args = arguments();
                                    expr = new JMessageExpression(line, newTarget, null,
                                                                  token.image, args
                                    );
                                    break;
                                default:
                ...
                case IDENTIFIER:
                    ...
                    if (ambiguousPart(id) == null) {
                        ...
                        expr = new JFieldSelection(line, ambiguousPart(id), null,
                                                   id.simpleName()
                        );
                    }
                    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                        case LPAREN:
                            args = arguments();
                            expr = new JMessageExpression(line, null, ambiguousPart(id),
                                                          id.simpleName(), args
                            );
                            break;
                        default:
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[]{0x100000, 0x8000, 0x2e00480, 0x0, 0x2e00080, 0x2e00080,
                0x1000, 0x22e20380, 0x20020300, 0x0, 0x20300, 0x5d0e6300, 0x5d0c6000,
                0x1c0c2000, 0x5d0c6000, 0x0, 0x20300, 0x0, 0x0, 0x1c0c2000, 0x0,
                0x1c0c2000, 0x0, 0x1c0c2000, 0x20300, 0x20300, 0x0, 0x0, 0x20300, 0x0,
                0x0, 0x0, 0x0, 0x10000, 0x10000, 0x80000000, 0x80000000, 0x0, 0x1c0c2000,
                0x0, 0x1c0c2000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1c0c2000,
                0x20300, 0x0, 0x0, 0x0, 0x10082000,
        };
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[]{0x0, 0x0, 0x0, 0x80000, 0x0, 0x0, 0x0, 0x100000, 0x100000,
                0x22000, 0x100000, 0x7122990, 0x7122990, 0x7100990, 0x7122990, 0x40000,
                0x100000, 0x40000, 0x1, 0x7102990, 0x40000, 0x7102990, 0x40000, 0x7100990,
                0x0, 0x0, 0x8000, 0x8000, 0x100000, 0x201, 0x201, 0x20, 0x4, 0x48, 0x48,
                0x100, 0x100, 0x400, 0x7100990, 0x80, 0x7100800, 0x88000, 0x2, 0x800,
                0x88000, 0x800, 0x800, 0x80800, 0x800, 0x7100800, 0x100000, 0x2000, 0x800,
                0x8000, 0x7000000,
        };
    }
