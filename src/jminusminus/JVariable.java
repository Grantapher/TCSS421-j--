        ...
        if (iDefn == null) {
            ...
            if (field == null) {
                ...
                JAST.compilationUnit
                        .reportSemanticError(line, "Cannot find name: \"%s\". (first occurrence)", name);
                context.addEntry(line(), name(), new LocalVariableDefn(type(), ((LocalContext) context).nextOffset()));
            } else {
        ...
        if (iDefn instanceof LocalVariableDefn) {
            ...
            if (type.isReference()) {
                ...
                if (type == Type.INT || type == Type.BOOLEAN || type == Type.CHAR) {
                    ...
                    switch (offset) {
                        case 0:
                            output.addNoArgInstruction(FLOAD_0);
                            break;
                        case 1:
                            output.addNoArgInstruction(FLOAD_1);
                            break;
                        case 2:
                            output.addNoArgInstruction(FLOAD_2);
                            break;
                        case 3:
                            output.addNoArgInstruction(FLOAD_3);
                            break;
                        default:
                            output.addOneArgInstruction(FLOAD, offset);
                            break;
                    }
