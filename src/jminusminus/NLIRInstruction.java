...
class NLIRConditionalJump extends NLIRInstruction {
    ...
    public NLIRConditionalJump(NBasicBlock block, int id, NLIRInstruction lhs,
                               NLIRInstruction rhs, int opcode,
...
class NLIRALoad extends NLIRInstruction {
    ...
    public NLIRALoad(NBasicBlock block, int id, int opcode, NLIRInstruction arrayRef,
                     NLIRInstruction index, String sType, String lType) {
        super(block, id);
        this.opcode = opcode;
...
class NLIRAStore extends NLIRInstruction {
    ...
    public NLIRAStore(NBasicBlock block, int id, int opcode, NLIRInstruction arrayRef,
                      NLIRInstruction index, NLIRInstruction value, String sType,
                      String lType) {
        super(block, id);
        this.opcode = opcode;
        reads.add(arrayRef.write);
...
class NLIRStore extends NLIRInstruction {
    ...
    public String toString() {
        return id + ": STORE " + reads.get(0) + " " +
                (offsetFrom == OffsetFrom.FP ? "[frame:" : "[stack:") + offset + "]";
    }
