            ...
            switch (operandBytes) {
                ...
                case 4:
                    ...
                    p.printf("%-10s%-17s%-5s%-5s%-5s%-5s\n", pc, mnemonic, operandByte1,
                             operandByte2, operandByte3, operandByte4
                    );
                    break;
                case DYNAMIC: // Variable length instructions
                    if (opcode == TABLESWITCH) {
                        ...
                        pad = 4 - ((i + 1) % 4);
                        i = i + pad + 1;
                        deflt = intValue(code.get(i++), code.get(i++), code.get(i++),
                                         code.get(i++)
                        );
                        low = intValue(code.get(i++), code.get(i++), code.get(i++),
                                       code.get(i++)
                        );
                        high = intValue(code.get(i++), code.get(i++), code.get(i++),
                                        code.get(i)
                        );
                        p.printf("%-10s%s { // %s to %s \n", pc, mnemonic, low, high);
                        ...
                        nPairs = intValue(code.get(i++), code.get(i++), code.get(i++),
                                          code.get(i)
                        );
                        p.printf("%-10s%s { \n", pc, mnemonic);
                        for (int idx = 0; idx < nPairs; idx++) {
                            int match = intValue(code.get(++i), code.get(++i),
                                                 code.get(++i), code.get(++i)
                            );
                            int offset = intValue(code.get(++i), code.get(++i),
                                                  code.get(++i), code.get(++i)
...
class CLInnerClassInfo {
    ...
    public void writeToStdOut(PrettyPrinter p) {
        p.printf("%-11s    %-17s    %-10s    %s\n", innerClassInfoIndex,
                 outerClassInfoIndex, innerNameIndex,
                 CLFile.innerClassAccessFlagsToString(innerClassAccessFlags)
        );
    }
...
class CLLineNumberTableAttribute extends CLAttributeInfo {
     ...
     * @param lineNumberTableLength LineNumberTable_attribute.line_number_table_length
     *                              item.
...
class CLLocalVariableTableAttribute extends CLAttributeInfo {
     ...
     *
     * @param attributeNameIndex       LocalVariableTable_attribute
     *                                 .attribute_name_index item.
     * @param attributeLength          LocalVariableTable_attribute.attribute_length item.
     * @param localVariableTableLength LocalVariableTable_attribute
     *                                 .local_variable_table_length item.
     * @param localVariableTable       LocalVariableTable_attribute
     *                                 .local_variable_table item.
     */
...
class CLLocalVariableTypeTableAttribute extends CLAttributeInfo {
     ...
     *
     * @param attributeNameIndex           LocalVariableTypeTable_attribute
     *                                     .attribute_name_index item.
     * @param attributeLength              LocalVariableTypeTable_attribute
     ...
     * @param localVariableTypeTable       LocalVariableTypeTable_attribute
...
class CLRuntimeVisibleAnnotationsAttribute extends CLAttributeInfo {
     ...
     *
     * @param attributeNameIndex RuntimeVisibleAnnotations_attribute
     *                           .attribute_name_index item.
     * @param attributeLength    RuntimeVisibleAnnotations_attribute.attribute_length
     *                           item.
...
class CLRuntimeInvisibleAnnotationsAttribute extends CLAttributeInfo {
     ...
     *
     * @param attributeNameIndex RuntimeInvisibleAnnotations_attribute
     *                           .attribute_name_index
     *                           item.
     * @param attributeLength    RuntimeInvisibleAnnotations_attribute.attribute_length
     *                           item.
     * @param numAnnotations     RuntimeVisibleAnnotations_attribute.num_annotations item.
...
class CLRuntimeVisibleParameterAnnotationsAttribute extends CLAttributeInfo {
     ...
     *                             attribute_name_index item.
     * @param attributeLength      RuntimeVisibleParameterAnnotations_attribute
     *                             .attribute_length
     *                             item.
     * @param numParameters        RuntimeVisibleParameterAnnotations_attribute
     *                             .num_parameters
     *                             item.
...
class CLRuntimeInvisibleParameterAnnotationsAttribute extends CLAttributeInfo {
     ...
     *                             attribute_length item.
     * @param numParameters        RuntimeInvisibleParameterAnnotations_attribute
     *                             .num_parameters
     *                             item.
