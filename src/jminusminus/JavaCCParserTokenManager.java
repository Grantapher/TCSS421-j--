...
public class JavaCCParserTokenManager implements JavaCCParserConstants {
    ...
    private final int jjStopStringLiteralDfa_0(int pos, long active0) {
        switch (pos) {
            ...
            case 2:
                ...
                if ((active0 & 0x60000L) != 0L) return 7;
                return -1;
            case 3:
                if ((active0 & 0x38080a00L) != 0L) return 7;
                ...
                return -1;
            case 4:
                if ((active0 & 0x44002400L) != 0L) return 7;
                ...
                return -1;
            case 5:
                if ((active0 & 0x3808000L) != 0L) return 7;
                ...
                return -1;
            case 6:
                if ((active0 & 0x301100L) != 0L) return 7;
            ...
            case 8:
                ...
                if ((active0 & 0x400000L) != 0L) return 7;
                return -1;
            default:
                return -1;
        }
    ...
    private final int jjMoveStringLiteralDfa1_0(long active0) {
        ...
        switch (curChar) {
            case 38:
                ...
                break;
            case 43:
                if ((active0 & 0x1000000000L) != 0L) return jjStopAtPos(1, 36);
                break;
            case 45:
                if ((active0 & 0x200000000L) != 0L) return jjStopAtPos(1, 33);
                break;
            case 61:
                if ((active0 & 0x400000000L) != 0L) return jjStopAtPos(1, 34);
                else if ((active0 & 0x4000000000L) != 0L) return jjStopAtPos(1, 38);
                else if ((active0 & 0x20000000000L) != 0L) return jjStopAtPos(1, 41);
                break;
            case 97:
            ...
            case 102:
                if ((active0 & 0x4000L) != 0L) return jjStartNfaWithStates_0(1, 14, 7);
                break;
            case 104:
    ...
    private final int jjMoveStringLiteralDfa2_0(long old0, long active0) {
        ...
        switch (curChar) {
            ...
            case 116:
                if ((active0 & 0x20000L) != 0L) return jjStartNfaWithStates_0(2, 17, 7);
                return jjMoveStringLiteralDfa3_0(active0, 0x1001000L);
            case 117:
                return jjMoveStringLiteralDfa3_0(active0, 0x10000000L);
            case 119:
                if ((active0 & 0x40000L) != 0L) return jjStartNfaWithStates_0(2, 18, 7);
                break;
            default:
                break;
        }
    ...
    private final int jjMoveStringLiteralDfa3_0(long old0, long active0) {
        ...
        switch (curChar) {
            case 100:
                ...
                break;
            case 101:
                if ((active0 & 0x800L) != 0L) return jjStartNfaWithStates_0(3, 11, 7);
            ...
            case 108:
                if ((active0 & 0x80000L) != 0L) return jjStartNfaWithStates_0(3, 19, 7);
                return jjMoveStringLiteralDfa4_0(active0, 0x40800100L);
            case 111:
                return jjMoveStringLiteralDfa4_0(active0, 0x8000L);
            case 114:
                if ((active0 & 0x200L) != 0L) return jjStartNfaWithStates_0(3, 9, 7);
                break;
            case 115:
                if ((active0 & 0x8000000L) != 0L) return jjStartNfaWithStates_0(3, 27, 7);
    ...
    private final int jjMoveStringLiteralDfa4_0(long old0, long active0) {
        ...
        switch (curChar) {
            ...
            case 101:
                if ((active0 & 0x2000L) != 0L) return jjStartNfaWithStates_0(4, 13, 7);
            ...
            case 114:
                if ((active0 & 0x4000000L) != 0L) return jjStartNfaWithStates_0(4, 26, 7);
                return jjMoveStringLiteralDfa5_0(active0, 0x1008080L);
            case 115:
                if ((active0 & 0x400L) != 0L) return jjStartNfaWithStates_0(4, 10, 7);
                break;
            default:
                break;
        }
    ...
    private final int jjMoveStringLiteralDfa5_0(long old0, long active0) {
        ...
        switch (curChar) {
            ...
            case 99:
                if ((active0 & 0x800000L) != 0L) return jjStartNfaWithStates_0(5, 23, 7);
            ...
            case 110:
                if ((active0 & 0x1000000L) != 0L) return jjStartNfaWithStates_0(5, 24, 7);
                return jjMoveStringLiteralDfa6_0(active0, 0x10000L);
            case 116:
                if ((active0 & 0x8000L) != 0L) return jjStartNfaWithStates_0(5, 15, 7);
    ...
    private final int jjMoveStringLiteralDfa6_0(long old0, long active0) {
        ...
        switch (curChar) {
            ...
            case 101:
                if ((active0 & 0x100000L) != 0L) return jjStartNfaWithStates_0(6, 20, 7);
                else if ((active0 & 0x200000L) != 0L)
                    return jjStartNfaWithStates_0(6, 21, 7);
                break;
            case 110:
                if ((active0 & 0x100L) != 0L) return jjStartNfaWithStates_0(6, 8, 7);
                break;
            case 115:
                if ((active0 & 0x1000L) != 0L) return jjStartNfaWithStates_0(6, 12, 7);
                break;
            case 116:
    ...
    private final int jjMoveStringLiteralDfa7_0(long old0, long active0) {
        ...
        switch (curChar) {
            ...
            case 116:
                if ((active0 & 0x80L) != 0L) return jjStartNfaWithStates_0(7, 7, 7);
                break;
            default:
                break;
        }
    ...
    private final int jjMoveStringLiteralDfa8_0(long old0, long active0) {
        ...
        switch (curChar) {
            case 100:
                if ((active0 & 0x400000L) != 0L) return jjStartNfaWithStates_0(8, 22, 7);
                break;
            case 111:
    ...
    private final int jjMoveStringLiteralDfa9_0(long old0, long active0) {
        ...
        switch (curChar) {
            case 102:
                if ((active0 & 0x10000L) != 0L) return jjStartNfaWithStates_0(9, 16, 7);
                break;
            default:
                break;
        }
                ...
                do {
                    switch (jjstateSet[--i]) {
                        ...
                        case 0:
                            ...
                            break;
                        case 1:
                            if ((0xffffffffffffdbffL & l) != 0L) jjCheckNAddStates(5, 7);
                            break;
                        case 2:
    ...
    static final int[] jjnextStates = {17, 19, 20, 12, 15, 1, 2, 4,
    };
    public static final String[] jjstrLiteralImages = {"", null, null, null, null, null,
            ...
            "\143\150\141\162", "\143\154\141\163\163", "\145\154\163\145",
            "\145\170\164\145\156\144\163", "\146\141\154\163\145", "\151\146",
            "\151\155\160\157\162\164", "\151\156\163\164\141\156\143\145\157\146",
            "\151\156\164", "\156\145\167", "\156\165\154\154",
            "\160\141\143\153\141\147\145", "\160\162\151\166\141\164\145",
            "\160\162\157\164\145\143\164\145\144", "\160\165\142\154\151\143",
            "\162\145\164\165\162\156", "\163\164\141\164\151\143",
            "\163\165\160\145\162", "\164\150\151\163", "\164\162\165\145",
            "\166\157\151\144", "\167\150\151\154\145", "\53", "\75", "\55\55", "\75\75",
            "\76", "\53\53", "\46\46", "\74\75", "\41", "\55", "\53\75", "\52", "\50",
            "\51", "\173", "\175", "\133", "\135", "\73", "\54", "\56", null, null, null,
            null, null, null, null, null, null,
    };
    public static final String[] lexStateNames = {"DEFAULT",
    };
    static final long[] jjtoToken = {0x171fffffffffff81L,
    };
    ...
    public void SwitchTo(int lexState) {
        if (lexState >= 1 || lexState < 0) throw new TokenMgrError(
